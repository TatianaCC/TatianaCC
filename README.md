...
.btn {
  ...
  margin: 5px;
  padding: 10px;
  background: linear-gradient(to right,#f7f4d7, #f7f3c1); /* Degradado de color */
  color: black;
  text-align: center;
  text-decoration: none;
  border-radius: 4px;
...
.btn:hover {
  background: linear-gradient(to right, #f7f3c1, #f7f4d7; /* Cambio de color al pasar el ratón */
  color: black;
}
</style>
